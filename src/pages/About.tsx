	...
	return (
		<>
			<section className="space-y-5">
				...
				<Button variant="secondary" className="rounded-full">view my resume</Button>
			...
			<section className="space-y-5">
				<h2 className="scroll-m-20 text-center pb-2 text-lg -tracking-tight first:mt-0 font-bold text-muted-foreground">technologies I used</h2>
				<Stack />
			</section>
		</>
	);
